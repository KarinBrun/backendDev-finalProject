...
const { db, User, Pets, Visits, Treatments } = require('./database/setup');
...
app.delete('/api/pets/:id', requireAuth, requireAdmin, async (req, res) => {
    try {
...
app.delete('/api/visits/:id', requireAuth, requireAdmin, async (req, res) => {
    try {
...
app.get('/api/treatments', requireAuth, requireVet, async (req, res) => {
    try {
...
app.get('/api/treatments/:id', requireAuth, requireVet, async (req, res) => {
    try {
...
app.post('/api/treatments', requireAuth, requireVet, async (req, res) => {
    try {
...
app.put('/api/treatments/:id', requireAuth, requireVet, async (req, res) => {
    try {
        const { issue, description, instructions, visitsId } = req.body;
...
app.delete('/api/treatments/:id', requireAuth, requireAdmin, async (req, res) => {
    try {
